...
<nav class="ava-navbar">
    ...
    <div class="ava-nav-actions">
        ...
        <!-- Notificações (Alerta/Sino) -->
        <button class="ava-icon-btn" title="Notificações">
        ...
        <!-- Configurações -->
        <a href="dashboard.php" class="ava-icon-btn" title="Ir para Painel Administrativo">
