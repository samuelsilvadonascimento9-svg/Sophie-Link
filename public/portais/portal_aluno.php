...
<body>
                                    ...
                                    <?php foreach ($faturas as $fat): ?>
                                        <div class="fatura-row" data-status="<?= htmlspecialchars($fat['status']) ?>" style="display: flex; justify-content: space-between; align-items: center; border: 1px solid #E2E8F0; padding: 16px; border-radius: 6px; background: #fff;">
                                            ...
                                            <div style="width: 30%; display: flex; flex-direction: column; align-items: flex-end; gap: 8px;">
                                                ...
                                                <?php else: ?>
                                                    <button onclick="iniciarPagamento(<?= $fat['id'] ?>)" style="background: #10B981; color: #fff; border: none; padding: 6px 12px; border-radius: 4px; font-size: 0.8rem; font-weight: 500; cursor: pointer; display: flex; align-items: center; justify-content: center; width: 100%; gap: 6px;"><i data-lucide="credit-card" style="width:14px;height:14px;"></i> Cartão/Boleto</button>
                                                    <button onclick="gerarPix(<?= $fat['id'] ?>)" style="background: #0db1a1; color: #fff; border: none; padding: 6px 12px; border-radius: 4px; font-size: 0.8rem; font-weight: 500; cursor: pointer; display: flex; align-items: center; justify-content: center; width: 100%; gap: 6px;"><i data-lucide="zap" style="width:14px;height:14px;"></i> Pagar com PIX</button>
                                                <?php endif; ?>
                                            </div>
    ...
    <script src="../assets/js/portais/aluno.js?v=13"></script>
    <!-- Modal PIX -->
