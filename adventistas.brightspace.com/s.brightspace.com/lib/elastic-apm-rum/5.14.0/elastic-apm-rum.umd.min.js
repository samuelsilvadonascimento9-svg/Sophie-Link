! function() {
    ...
    n.n = function(t) {
        ...
        function() {
            ...
            }, o.prototype.finally = e, o.all = function(t) {
            ...
            for (var S = [], _ = 0; _ < 256; ++_) S[_] = (_ + 256).toString(16).substr(1);
            ...
            var X = "invoke",
                G = ["link", "css", "script", "img", "xmlhttprequest", "fetch", "beacon", "iframe"],
                Z = "page-load",
                Y = [Z, "route-change", "user-interaction", "http-request", "custom", "temporary"],
                Q = ["tags"];
            ...
            function ft(t, e, n) {
                var r = function(t, e, n, r) {
                    return void 0 === e && (e = 1024), void 0 === n && (n = !1), void 0 === r && (r = "N/A"), n && ut(t) && (t = r), "string" == typeof t ? t.substring(0, e) : t
                }(t[e], n[0], n[1]);
            ...
            var yt = function() {
                ...
                St = ["fetchStart", "domainLookupStart", "domainLookupEnd", "connectStart", "connectEnd", "requestStart", "responseStart", "responseEnd", "domLoading", "domInteractive", "domContentLoadedEventStart", "domContentLoadedEventEnd", "domComplete", "loadEventStart", "loadEventEnd"],
                _t = ["fs", "ls", "le", "cs", "ce", "qs", "rs", "re", "dl", "di", "ds", "de", "dc", "es", "ee"];
            ...
            function Tt(t) {
                ...
                if (n && (e.p = {
                        ...
                        var e = {},
                            ...
                            i = t.url,
                            a = t.response;
                        return e.url = i, n && (e.mt = n), r && (e.sc = r), a && (e.r = wt(a)), e
                    }(r)), i && (e.r = wt(i)), a) {
                    var c = a.service;
                    e.dt = {
                        se: {
            ...
            function Et(t) {
                ...
                var e = function(t) {
                    if (!t) return null;
                    var e = {};
                    return _t.forEach((function(n, r) {
                        var i = St[r];
                        e[n] = t[i]
                    })), e
                }(t.navigationTiming);
            ...
            function qt(t, e, n) {
                ...
                if (r && !(i = r[c])) {
                    ...
                    if (!(s = u) || !1 !== s.writable && ("function" != typeof s.get || void 0 !== s.set)) {
                        ...
                        }, a = r[e], o = i, a[Rt("OriginalDelegate")] = o
                    }
                }
                return i
            }
            ...
            function Ht(t, e, n) {
                ...
                return new h((function(n, r) {
                    ...
                    if (u[Ft] = !0, u.open(t, e, !0), u.timeout = i, u.withCredentials = c, o)
            ...
            var Ut = function() {
                    function t(t, e) {
                        this._configService = t, this._loggingService = e, this.queue = void 0, this.throttleEvents = q
                    }
                    var e = t.prototype;
                    return e.init = function() {
                        ...
                        return !c && Nt(t, o) ? function(t, e, n) {
                            var r, i = n.keepalive,
                                a = void 0 !== i && i,
                                o = n.timeout,
                                s = void 0 === o ? 1e4 : o,
                            ...
                            if (n instanceof TypeError) return Ht(t, e, {
                                timeout: a,
                                payload: o,
                                headers: s,
                                beforeSend: c,
                        ...
                        if (!t) return h.reject("serviceName is required for fetching central config.");
                        ...
                        return t.map((function(t) {
                            var r;
                            return yt.stringify(((r = {})[n] = e ? function(t) {
                                var e, n = t.exception,
                                    r = {
                                        id: t.id,
                                        cl: t.culprit,
                        ...
                        return t.map((function(t) {
                            ...
                            })).join(""), delete t.spans), t.breakdown && (o = n.ndjsonMetricsets(t.breakdown), delete t.breakdown)), yt.stringify(((i = {})[r] = e ? function(t) {
                            ...
                            if (0 !== r.length || 0 !== i.length) {
                                ...
                                if (u) {
                                    var f = s.get("apiVersion") > 2,
                                        ...
                                        p = f ? "m" : "metadata";
                                    d.push(yt.stringify(((n = {})[p] = f ? function(t) {
                                        var e = t.service,
                                            n = t.labels,
                                            r = e.agent,
                                            i = e.language;
            ...
            var Bt, Vt = function() {
                    function t() {
                        this.config = {
                            ...
                            apmRequest: null,
                            sendCredentials: !1
                        }, this.events = new zt, this.filters = [], this.version = ""
                    }
                    var e = t.prototype;
                    return e.init = function() {
                        var t = function(t) {
                        ...
                        var e = {},
                            ...
                            i = n.username,
                            a = n.email;
                        "number" != typeof r && "string" != typeof r || (e.id = r), "string" == typeof i && (e.username = i), "string" == typeof a && (e.email = a), this.config.context.user = I(this.config.context.user || {}, e)
                    }, e.setCustomContext = function(t) {
                        void 0 === t && (t = {}), this.config.context.custom = I(this.config.context.custom || {}, t)
                        ...
                        var e = t,
                            ...
                            r = e.serverUrl;
                        r && (t.serverUrl = r.replace(/\/+$/, "")), R(n) || (n < 1e-4 && n > 0 && (n = 1e-4), t.transactionSampleRate = Math.round(1e4 * n) / 1e4), j(this.config, t), this.events.send("config:change", [this.config])
                        ...
                        if (t) {
                            if (e) t = Dt({}, this.getLocalConfig(), t);
                ...
                Jt = ((Bt = {}).ConfigService = function() {
                    return new Vt
                }, Bt.LoggingService = function() {
                    return new $t({
                        prefix: "[Elastic APM] "
                    })
                }, Bt.ApmServer = function(t) {
                ...
                Xt = function() {
                    ...
                    return e.init = function() {
                        ...
                        var e = this;
                        return "string" == typeof t ? (this.instances[t] || "function" == typeof Jt[t] && (this.instances[t] = Jt[t](this)), this.instances[t]) : Array.isArray(t) ? t.map((function(t) {
            ...
            function Gt(t) {
                ...
                if (e && e.addEventListener) var n = qt(e, "open", (function() {
                        return function(t, e) {
                            return t[Ft] || (t[Mt] = e[0], t[Pt] = e[1], t[At] = !1 === e[2]), n.apply(t, e)
                        }
                    })),
                    r = qt(e, "send", (function() {
                        return function(e, n) {
                            if (e[Ft]) return r.apply(e, n);
                            var a = {
                ...
                function i(e, n) {
                    e.state !== X && (e.state = X, e.data.status = n, t(X, e))
                }
            }
            var Zt = new zt,
                Yt = !1;
            ...
            function Qt() {
                return Yt || (Yt = !0, Gt((function(t, e) {
                    Zt.send("xmlhttprequest", [t, e])
                })), function(t) {
                    if (It()) {
                        var e = window.fetch;
                        window.fetch = function(t, o) {
                            ...
                            return new h((function(t, o) {
                                var c;
                                jt.fetchInProgress = !0, n(l);
                                try {
                                    c = e.apply(u, [s])
                                } catch (t) {
                                    return o(t), l.data.error = t, r(l), void(jt.fetchInProgress = !1)
                                }
                                c.then((function(e) {
            ...
            var Wt = function() {
                    ...
                    return e.init = function(t) {
                        ...
                        })), t.history && Zt.observe("history", this.getHistorySub()), t.xmlhttprequest && Zt.observe("xmlhttprequest", this.getXHRSub()), t.fetch && Zt.observe("fetch", this.getFetchSub())
                        ...
                        var t = this;
                        return function(e, n) {
                            "xmlhttprequest" !== n.source || jt.fetchInProgress || t.processAPICalls(e, n)
                        }
                ...
                Kt = function() {
                    function t(t, e, n) {
                        void 0 === n && (n = {}), t || (t = "Unknown"), e || (e = "custom"), this.name = t, this.type = e, this.options = n, this.id = n.id || w(16), this.traceId = n.traceId, this.sampled = n.sampled, this.sampleRate = n.sampleRate, this.timestamp = n.timestamp, this._start = M(n.startTime), this._end = void 0, this.ended = !1, this.outcome = void 0, this.onEnd = n.onEnd
                    }
                    var e = t.prototype;
            ...
            var ee = function(t) {
                    ...
                    return n = t, (e = r).prototype = Object.create(n.prototype), e.prototype.constructor = e, te(e, n), r.prototype.end = function(e, n) {
                        t.prototype.end.call(this, e), et(this, n)
                    }, r
                }(Kt),
                ne = [
            ...
            function ie(t, e) {
                ...
                return {
                    ...
                    span: n,
                    samples: {
                        "span.self_time.count": re(i),
                        "span.self_time.sum.us": re(1e3 * a)
                    }
                }
            }
            ...
            var oe = function(t) {
                    ...
                    function r(e, n, r) {
                        var i;
                        return (i = t.call(this, e, n, r) || this).traceId = w(), i.marks = void 0, i.spans = [], i._activeSpans = {}, i._activeTasks = new Set, i.blocked = !1, i.captureTimings = !1, i.breakdownTimings = [], i.sampleRate = i.options.transactionSampleRate, i.sampled = Math.random() <= i.sampleRate, i
                    }
                    n = t, (e = r).prototype = Object.create(n.prototype), e.prototype.constructor = e, ae(e, n);
                    var i = r.prototype;
                    return i.addMarks = function(t) {
                        ...
                        t && (this.name = t), e && (this.type = e), n && (this.options.reuseThreshold = n.reuseThreshold, I(this.options, n))
                        ...
                        return t || (t = "task-" + w(16)), this._activeTasks.add(t), t
            ...
            function ce(t, e) {
                        ...
                        spans: function(t, e) {
                            for (var n = [], r = 0; r < t.length; r++) {
                                ...
                                if (e.count++, e.duration += s, e.max = Math.max(s, e.max), c.length > 0) {
                                    ...
                                    v && (g.name = v), h && (g.id = h), f.addContext({
                                        custom: g
                                    })
                                }
                                f.end(u), n.push(f)
                ...
                if (s) {
                    ...
                    se.lcp = c, a.marks.largestContentfulPaint = c
                }
                var u = y.timing,
                ...
                if (d) {
                    ...
                    se.fcp = l, a.marks.firstContentfulPaint = l
                }
                var p = function(t) {
                    var e = t[0];
                    if (e) {
                        var n = e.startTime,
                            r = e.processingStart,
                            i = new ee("First Input Delay", "first-input", {
                                startTime: n
                            });
                        return i.end(r), i
                    }
                }(t.getEntriesByType("first-input"));
                return p && (se.fid = p.duration(), a.spans.push(p)),
                    function(t) {
                        t.forEach((function(t) {
                            var e = t.name,
                                n = t.startTime,
                                r = t.duration;
                            if (!(n < se.fcp || "self" !== e && -1 === e.indexOf("same-origin"))) {
                                se.tbt.start = Math.min(se.tbt.start, n);
                                var i = r - 50;
                                i > 0 && (se.tbt.duration += i)
                            }
                        }))
                    }(i),
                    function(t) {
                        t.forEach((function(t) {
                            !t.hadRecentInput && t.value && ((t.startTime - se.cls.firstEntryTime > 5e3 || t.startTime - se.cls.prevEntryTime > 1e3) && (se.cls.firstEntryTime = t.startTime, se.cls.currentSessionScore = 0), se.cls.prevEntryTime = t.startTime, se.cls.currentSessionScore += t.value, se.cls.score = Math.max(se.cls.score, se.cls.currentSessionScore))
                        }))
            ...
            function ve(t) {
                if (t.captureTimings) {
                    ...
                    if (t.type === Z) {
                        ...
                        var r = y.timing;
                        (function(t, e, n, r) {
                            for (var i = [], a = 0; a < de.length; a++) {
                                var o = t[de[a][0]],
                                    s = t[de[a][1]];
                                if (fe(o, s, n, r, e)) {
                                    var c = new ee(de[a][2], "hard-navigation.browser-timing"),
                                        u = null;
                                    "requestStart" === de[a][0] && (c.pageResponse = !0, u = {
                                        url: location.origin
                                    }), c._start = o - e, c.end(s - e, u), i.push(c)
                                }
                            }
                            return i
                        ...
                        (function(t, e, n, r) {
                            for (var i = [], a = 0; a < t.length; a++) {
                                var o = t[a],
                                    ...
                                    c = o.name,
                                    u = o.startTime,
                                    f = o.responseEnd; - 1 !== G.indexOf(s) && null != c && (("xmlhttprequest" === s || "fetch" === s) && (/intake\/v\d+\/rum\/events/.test(c) || pe(u, e)) || fe(u, f, n, r) && i.push(le(t[a])))
                            }
                            return i
                        })(y.getEntriesByType("resource"), Ct.bootstrapTime, i, e).forEach((function(e) {
            ...
            var he = function() {
                function t(t, e) {
                    var n = this;
                    this._config = e, this._logger = t, this.currentTransaction = void 0, this.respIntervalId = void 0, this.recorder = new ue((function(t) {
                        ...
                        if (e && e.captureTimings) {
                            var r, i = e.type === Z,
                                ...
                                o = a.spans,
                                s = a.marks;
                            (r = e.spans).push.apply(r, o), e.addMarks({
                                agent: s
                            })
                        }
                    }))
                ...
                return e.createCurrentTransaction = function(t, e, n) {
                    ...
                    var r, i = this,
                        ...
                        o = !0;
                    a.managed ? this.currentTransaction === (r = this.startManagedTransaction(t, e, a)) && (o = !1) : r = new oe(t, e, a);
                    ...
                    return h.resolve().then((function() {
                        var r = t.name,
                            i = t.type;
                        if (!(Ct.lastHiddenStart >= t._start || e.shouldIgnoreTransaction(r) || "temporary" === i)) {
                            if (i === Z) {
                                ...
                                if ("Unknown" === r && a && (t.name = a), t.captureTimings) {
                                    var o = se.cls,
                                        ...
                                        c = se.tbt,
                                        u = se.longtask;
                                    c.duration > 0 && t.spans.push((d = (f = c).start, l = f.duration, (p = new ee("Total Blocking Time", "longtask", {
                                        startTime: d
                                    })).end(d + l), p)), t.experience = {}, D("longtask") && (t.experience.tbt = c.duration), D("layout-shift") && (t.experience.cls = o.score), s > 0 && (t.experience.fid = s), u.count > 0 && (t.experience.longtask = {
                                        count: u.count,
                                        sum: u.duration,
                                        max: u.max
                                    })
                            ...
                            "Unknown" === t.name && (t.name = function(t, e) {
                                ...
                                for (var n = new J(t), r = n.query, i = n.path.substring(1).split("/"), a = /\W|_/g, o = /[0-9]/g, s = /[a-z]/g, c = /[A-Z]/g, u = [], f = !1, d = 0; d < i.length; d++) {
                                    ...
                                    if ((l.match(a) || []).length >= 2) u.push(":id"), f = !0;
                                        ...
                                        if (p > 3 || l.length > 3 && p / l.length >= .3) u.push(":id"), f = !0;
                                        else {
                            ...
                            }(n)), ve(t), e.adjustTransactionTime(t), e._config.get("breakdownMetrics") && t.captureBreakdown();
                            var v = e._config.get("context");
                            nt(t, v), e._config.events.send("transaction:end", [t])
                        }
                    }), (function(t) {
                        0
                    }))
            ...
            function ye() {
                return x() ? (Qt(), Ct.bootstrapTime = P(), me = !0) : m && console.log("[Elastic APM] platform is not supported!"), me
            }
            ...
            function Se(t, e) {
                ...
                if (n) {
                    var r = t.observeEvent("queue:add_transaction", (function() {
                        t.dispatchEvent("queue:flush"), Ct.lastHiddenStart = P(), r()
                    }));
                    n.end()
                } else t.dispatchEvent("queue:flush"), Ct.lastHiddenStart = P()
            }
                ...
                return e.isEnabled = function() {
                    ...
                    if (this.isEnabled() && !this._initialized) {
                        ...
                        var n = this.serviceFactory.getService(["ConfigService", "LoggingService", "TransactionService"]),
                            ...
                            i = n[1],
                            a = n[2];
                        r.setVersion("5.14.0"), this.config(t);
                        var o = r.get("logLevel");
                        if (i.setLevel(o), r.get("active")) {
                            this.serviceFactory.init();
                            var s = function(t, e) {
                                var n, r = ((n = {}).xmlhttprequest = !1, n.fetch = !1, n.history = !1, n[Z] = !1, n.error = !1, n.eventtarget = !1, n.click = !1, n);
                            ...
                            var u = function() {
                                return s[Z] && e._sendPageLoadMetrics()
                            };
                            r.get("centralConfig") ? this.fetchCentralConfig().then(u) : u(),
                                function(t, e) {
                                    "hidden" === document.visibilityState && (Ct.lastHiddenStart = 0);
                                    var n = function() {
                                            "hidden" === document.visibilityState && Se(t, e)
                                        },
                                        r = function() {
                                            return Se(t, e)
                                        };
                                    window.addEventListener("visibilitychange", n, !0), window.addEventListener("pagehide", r, !0)
                                }(r, a), s.eventtarget && s.click && _e(a)
                    ...
                    var t = this.startTransaction(void 0, Z, {
                        managed: !0,
                        canReuse: !0
                    });
                    if (t) {
            ...
            var we = function() {
                if (m && window.elasticApm) return window.elasticApm;
                var t = ye(),
                    e = ge(),
                    n = new be(e, !t);
                return m && (window.elasticApm = n), n
            }();
            we.init.bind(we)
        }()
}();
