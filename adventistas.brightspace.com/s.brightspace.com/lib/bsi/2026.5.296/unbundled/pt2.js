var e = {
    "components:accessibilityDisabilitySimulator:blurLevel": "Nível de desfoque",
    "components:accessibilityDisabilitySimulator:colorblindAchromatopsia": "Acromatopsia",
    "components:accessibilityDisabilitySimulator:colorblindDeuteranopia": "Deuteranopia",
    "components:accessibilityDisabilitySimulator:colorblindProtanopia": "Protanopia",
    "components:accessibilityDisabilitySimulator:colorblindTritanopia": "Tritanopia",
    "components:accessibilityDisabilitySimulator:colorblindness": "Daltonismo",
    "components:accessibilityDisabilitySimulator:keyboardOnly": "Somente teclado",
    "components:accessibilityDisabilitySimulator:lowVision": "Baixa visão",
    "components:accessibilityDisabilitySimulator:noVision": "Sem visão",
    "components:accessibilityDisabilitySimulator:none": "Nenhum",
    "components:accessibilityDisabilitySimulator:screenreaderAndTabAlert": "Ative seu leitor de tela e insira o conteúdo",
    "components:accessibilityDisabilitySimulator:simulationType": "Tipo de simulação:",
    "components:attributePicker:addValue": "Clique para adicionar o valor {value}",
    "components:attributePicker:limitReached": "Você atingiu o limite de {value} valores selecionados",
    "components:attributePicker:minimumRequirement": "Pelo menos um valor deve ser definido",
    "components:attributePicker:removeValue": "Clique, pressione a tecla Backspace ou a tecla Delete para remover o item {value}",
    "components:checkboxDrawer:checkboxCollapsed": "Caixa de seleção recolhida",
    "components:checkboxDrawer:checkboxExpanded": "Caixa de seleção expandida",
