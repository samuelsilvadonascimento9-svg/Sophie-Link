...
const n = s(class extends e {
    constructor(t) {
        if (super(t), t.type !== i.ATTRIBUTE || "class" !== t.name || t.strings ? .length > 2) throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")
    }
    render(t) {
